...
JOBS = [
    {"name": "post-api-cicd", "description": "Full pipeline: CI then CD in one run. Pipeline script + GitHub->Gitee wrapper. Set MODE=ci|cd|both to pick stages.", "mode_choices": ["both", "ci", "cd"]},
]
