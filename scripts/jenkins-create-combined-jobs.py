#!/usr/bin/env python3
"""Ensure post-api-{ci,cd,cicd} exist on Jenkins as
...
JOBS = [
    {"name": "post-api-ci",   "description": "CI: build, test, push image. Pipeline script + GitHub->Gitee wrapper.",          "mode_choices": ["ci",   "cd", "both"]},
    {"name": "post-api-cd",   "description": "CD: deploy image to k8s. Pipeline script + GitHub->Gitee wrapper.",              "mode_choices": ["cd",   "ci", "both"]},
    {"name": "post-api-cicd", "description": "Full pipeline: CI then CD in one run. Pipeline script + GitHub->Gitee wrapper.", "mode_choices": ["both", "ci", "cd"]},
]
...
{choices}            </a>
        ...
        <hudson.model.StringParameterDefinition>
          ...
          <defaultValue>post-api</defaultValue>
          <trim>false</trim>
        </hudson.model.StringParameterDefinition>
        <hudson.model.StringParameterDefinition>
          <name>DB_HOST</name>
